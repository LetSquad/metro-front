...
import styles from "./styles/OrdersDistributionSchedule.module.scss";

interface OrdersDistributionTableProps {
    ordersTimeList: OrdersTimeList[];
}

export default function OrdersDistributionSchedule({ ordersTimeList }: OrdersDistributionTableProps) {
